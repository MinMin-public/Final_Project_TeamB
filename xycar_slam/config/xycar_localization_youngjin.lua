...
TRAJECTORY_BUILDER_2D.max_range = 10.--14.
TRAJECTORY_BUILDER_2D.missing_data_ray_length = 10.--14.
...
TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.max_range = 30.
...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 15--10
...
POSE_GRAPH.optimization_problem.local_slam_pose_translation_weight = 1e6--1e5
POSE_GRAPH.optimization_problem.local_slam_pose_rotation_weight = 1e6--1e5
POSE_GRAPH.optimization_problem.odometry_translation_weight = 1e6--1e5
POSE_GRAPH.optimization_problem.odometry_rotation_weight = 1e6--1e5
POSE_GRAPH.optimization_problem.fixed_frame_pose_translation_weight = 1e2--1e1
